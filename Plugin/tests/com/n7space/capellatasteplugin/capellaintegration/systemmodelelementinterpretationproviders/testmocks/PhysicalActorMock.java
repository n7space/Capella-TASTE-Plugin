...
public class PhysicalActorMock implements PhysicalActor {

	protected final String name;
	protected final EList<PhysicalComponent> deployedComponents = new BasicEList<PhysicalComponent>();
	protected final EList<AbstractPropertyValue> appliedPropertyValues = new BasicEList<AbstractPropertyValue>();

	public void addDeployedComponent(final PhysicalComponent component) {
	...
	public PhysicalActorMock(final String actorName) {
		name = actorName;
	}
