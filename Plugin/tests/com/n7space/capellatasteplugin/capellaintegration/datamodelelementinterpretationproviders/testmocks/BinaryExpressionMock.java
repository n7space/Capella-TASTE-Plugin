...
public class BinaryExpressionMock implements BinaryExpression {

	protected final DataValue operand1;
	protected final DataValue operand2;
	protected final BinaryOperator operator;
	protected final String name;
	protected final DataType type;

	public BinaryExpressionMock(final String expressionName, final DataType expressionType,
			final BinaryOperator expressionOperator, final DataValue expressionOperand1,
			final DataValue expressionOperand2

	) {
		operand1 = expressionOperand1;
		operand2 = expressionOperand2;
		name = expressionName;
		type = expressionType;
	...
	@Override
	public void setOwnedLeftOperand(DataValue value) {
		// TODO Auto-generated method stub
	...
	@Override
	public void setOwnedRightOperand(DataValue value) {
		// TODO Auto-generated method stub
