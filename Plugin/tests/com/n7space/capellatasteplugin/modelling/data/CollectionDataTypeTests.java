...
public class CollectionDataTypeTests {
	...
	public void testGetDependencies() {
		...
		final CollectionDataType type = new CollectionDataType(pkg, "Collection", "Collection" + "_id",
				CollectionDataType.Ordering.Ordered, new DataTypeReference(containedType), minValueRef, maxValueRef);
