...
/**
 * Class providing ASN.1 definition for an integer data type.
 * 
 * @see IntegerDataType
 */
public class IntegerTypeDefinitionProvider extends BaseDefinitionProvider implements Asn1ElementDefinitionProvider {
	 ...
	 *            Name converter
	 */
	public IntegerTypeDefinitionProvider(final NameConverter converter) {
		super(converter);
	}

	protected String getBaseTypeName(final IntegerDataType dataType) {
	...
	protected String getUnit(final IntegerDataType dataType) {
	...
	public String provideAsn1Definition(final DataModel model, final DataModelElement element) {
		final IntegerDataType dataType = (IntegerDataType) element;
